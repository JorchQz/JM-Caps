              ...
              <tbody>
                {resultados.map((unidad) => (
                  <tr key={unidad.id}>
                    ...
                    <td className="numero">
                      {ofertaVigente(unidad.modelo) ? (
                        <>
                          <span className="tenue tachado">
                            {formatearMXN(unidad.modelo.precio_venta_mxn)}
                          </span>{' '}
                        </>
                      ) : null}
                      {formatearMXN(precioEfectivo(unidad.modelo.precio_venta_mxn, unidad.modelo))}
                    </td>
